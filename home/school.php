...
$get_user=mysqli_query($con,"SELECT * FROM `school`");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<script type="text/javascript">
 ...
 $('#clk').on('click',function() {
     ...
     if(schoolname!="" && shortname!="" && status!=""){
        $.ajax({
            url:"./cms/save.php?action=school",
            type:"POST",
            data:{
                id:id,
...
$('.edit').on('click', function() {
        var id=$(this).attr('id');
        $.ajax({
            url:"./cms/edit.php?action=school",
            type:"POST",
            data:{
                id:id,
            },
...
$('.delete').on('click', function() {
        ...
        var id=$(this).attr('id')
        $.ajax({
            url:"./cms/delete.php?action=school",
            type:"POST",
            data:{
                id:id,
            },
                ...
                <form action="" method="post" id="saveDegForm">              
                   ...
                   <!--  </div> -->
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"  class="form-control" name="schoolname" id="schoolname" placeholder="Enter School name" >
                         <label id="lblschoolname" style="color: red"></label> 
                    </div>
